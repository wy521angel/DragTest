...
public class VDHLayoutForButton extends LinearLayout {
    ...
    public VDHLayoutForButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    public VDHLayoutForButton(Context context) {
        this(context, null);
    }

    public VDHLayoutForButton(Context context, AttributeSet attrs) {
